...
async function resetTestMessage() {
  console.log('🔄 Resetting test message with specific_phone handling...');
  ...
  if (updateError) {
    ...
    console.log('📱 Specific phone handling will ensure it sends to your phone regardless of trigger type.');
  }
