...
export default function ReferralPage() {
  ...
  const [formData, setFormData] = useState<FormData>({
    ...
    company: '',
    city_state: '',
    referral: '', // This will be auto-filled with referrer name
    visit_frequency: '',
    go_to_drink: ''
  });
    ...
    return (
      ...
      >
        <VStack spacing={4}>
          ...
          <Text color="#ECEDE8" fontSize="lg">Validating referral link...</Text>
        </VStack>
      </Box>
    );
  }
      ...
      >
        ...
        <VStack spacing={6} align="stretch">
          ...
          {currentStepData.type === 'intro' && (
            <VStack spacing={6}>
              <Box
                bg="rgba(165, 148, 128, 0.2)"
                p={4}
                borderRadius="md"
                border="1px solid #a59480"
              >
                <Text color="#ECEDE8" fontSize="md" textAlign="center" fontWeight="600">
