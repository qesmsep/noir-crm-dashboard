...
import { isWithinBookingWindow, toBookingDay, VENUE_DEFAULT_TIMEZONE } from '../../../utils/bookingDays';
...
export async function POST(request: Request) {
  try {
    ...
    // caller's clock says
    if (dateStr < DateTime.now().setZone(venueTimezone).toFormat('yyyy-MM-dd')) {
