...
export default function CampaignEditPage() {
  ...
  const formatTiming = (template: CampaignTemplate) => {
    if (template.timing_type === 'specific_time') {
      ...
      if (template.duration_quantity) parts.push(template.duration_quantity);
      if (template.duration_unit) parts.push(template.duration_unit);
      if (template.duration_proximity) parts.push(template.duration_proximity);
      return parts.join(' ');
    }
  };
