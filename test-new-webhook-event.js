...
async function testNewWebhookEvent() {
  console.log('🔍 Testing New Webhook Event...\n');

  // New webhook event data
  const session = {
    id: 'cs_live_a1E2QPVSzZcGAzhDGYOwdCUuKBeYtZfFUWv3n0LipNNXNANVa67A6fGixB',
    customer: 'cus_Sf6Loq9C3XeoGo',
...
testNewWebhookEvent().catch(console.error); 