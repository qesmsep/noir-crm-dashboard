  ...
  try {
    ...
    const { data, error } = await supabase
      ...
      .insert([{
        ...
        party_size: 2,
        phone: '+15555550126',
        email: 'test-timezone-fix@noircrm.com',
        event_type: 'Test Timezone Fix',
        source: 'manual',
        first_name: 'Timezone',
        last_name: 'Fix Test',
        membership_type: 'member',
        notes: 'Test reservation for final timezone fix verification'
      }])
      .select();
    ...
    console.log('3. Verify the time updates to 8pm correctly');
