...
-- Also create a MEMBER trigger campaign that redirects to the same flow
-- This handles people who text "MEMBER" instead of "MEMBERSHIP"
INSERT INTO sms_intake_campaigns (id, name, trigger_word, status, actions, cancel_on_signup)
VALUES (
  gen_random_uuid(),
  'Membership Nurture Flow (MEMBER alias)',
  'MEMBER',
  'active',
  '{"create_onboarding_link": {"enabled": true, "token_expiry_hours": 72}}'::jsonb,
  true
