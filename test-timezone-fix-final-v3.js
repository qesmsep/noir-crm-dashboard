  ...
  try {
    ...
    const { data, error } = await supabase
      ...
      .insert([{
        ...
        party_size: 2,
        phone: '+15555550128',
        email: 'test-timezone-fix-v3@noircrm.com',
        event_type: 'Test Timezone Fix V3',
        source: 'manual',
        first_name: 'Timezone',
        last_name: 'Fix V3',
        membership_type: 'member',
        notes: 'Test reservation for final timezone fix verification - V3'
      }])
      .select();
    ...
    console.log('   This version correctly converts FullCalendar Date objects using the business timezone.');
